...
## ![Three Tier Web Application Architecture](c:\Users\deven\Downloads\3tierworkshop-15 Services.png)
...
```bash
git clone https://github.com/DevSecOps-for-AWS/3-tier-aws-15-services.git
```
